...
class ConcreteMediator(Mediator):
    ...
    def __init__(self) -> None:
        self._step_1 = OperateWrapper(self.event_finished, type("knife", (Operators,), {})())
        self._step_2 = OperateWrapper(self.event_finished, type("plate", (Operators,), {})())
        self._step_3 = OperateWrapper(self.event_finished, type("steak", (Operators,), {})())
